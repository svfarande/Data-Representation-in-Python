...
plt.ylabel('Random Normal', fontsize='medium')
plt.xlabel('Year',fontsize='medium')
plt.title('Interactive Random Plot')
...
def onhover(event):
    ...
    plt.xticks([1991.5,1992,1992.5,1993,1993.5,1994,1994.5,1995,1995.5],[None,'1992',None,'1993',None,'1994',None,'1995',None])
    plt.tick_params(axis = 'x', which='both',top=False,bottom =False)
    #plt.gca().spines['top'].set_visible(False)
    #plt.gca().spines['right'].set_visible(False)
